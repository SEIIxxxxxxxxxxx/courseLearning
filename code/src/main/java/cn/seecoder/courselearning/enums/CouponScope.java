...
public enum CouponScope {
    ...
    SINGLE("单个课程", (course,coupon) -> course.getId().equals(Integer.parseInt(JSONHelper.getByProperty(coupon.getMetadata(), "courseId").toString()))),
    TEACHER("某个老师的课程", (course, coupon) -> course.getId().equals(Integer.parseInt(JSONHelper.getByProperty(coupon.getMetadata(), "teacherId").toString()))),
    SCHOOL("某个学校的课程", (course, coupon) -> course.getId().equals(Integer.parseInt(JSONHelper.getByProperty(coupon.getMetadata(), "schoolId").toString()))),
